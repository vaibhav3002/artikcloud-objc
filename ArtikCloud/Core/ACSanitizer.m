...
NSString * ACPercentEscapedStringFromString(NSString *string) {
    ...
    [allowedCharacterSet removeCharactersInString:[kACCharactersGeneralDelimitersToEncode stringByAppendingString:kACCharactersSubDelimitersToEncode]];

...
NSString *const ACDeserializationErrorDomainKey = @"ACDeserializationErrorDomainKey";

NSInteger const ACTypeMismatchErrorCode = 143553;

NSInteger const ACEmptyValueOccurredErrorCode = 143509;

NSInteger const ACUnknownResponseObjectErrorCode = 143528;


@interface ACResponseDeserializer ()
...
@implementation ACResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:ACDeserializationErrorDomainKey code:ACTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:ACDeserializationErrorDomainKey code:ACEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:ACDeserializationErrorDomainKey code:ACUnknownResponseObjectErrorCode userInfo:userInfo];
}

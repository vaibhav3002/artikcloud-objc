 ...
 */
extern NSString *const ACDeserializationErrorDomainKey;

/**
 * Code for deserialization type mismatch error
 */
extern NSInteger const ACTypeMismatchErrorCode;

/**
 * Code for deserialization empty value error
 */
extern NSInteger const ACEmptyValueOccurredErrorCode;

/**
 * Error code for unknown response
 */
extern NSInteger const ACUnknownResponseObjectErrorCode;

@protocol ACResponseDeserializer <NSObject>
...
@interface ACResponseDeserializer : NSObject <ACResponseDeserializer>

...
#ifndef ACDebugLogResponse
#define ACDebugLogResponse(response, responseObject,request, error) [[ACLogger sharedLogger] logResponse:response responseObject:responseObject request:request error:error];
#endif
 ...
 */
#ifndef ACDebugLog
#define ACDebugLog(format, ...) [[ACLogger sharedLogger] debugLog:[NSString stringWithFormat:@"%s", __PRETTY_FUNCTION__] message: format, ##__VA_ARGS__];
#endif
...
/**
 * Enabled switch, default NO - default set by ACConfiguration debug property
 */
